...
- **Canonical OKF schema (mirror these rules exactly):** `~/Dev/agentic-portfolio/docs/okf-frontmatter.md` (brain decision D27). The three closed vocabularies, settled below against the live corpus:
  ...
  - **`project` — controlled, scalar.** Closed set: `bastion · bastion-ui · python-orchestration · learn-ai · rag-engine-rs · claude-sdk-rs · workflow-engine-rs · mev · bella · price-scout · amistad · base-template · brain`. Omitted entirely on cross-cutting docs — absence is **not** an error.
