...
now: "4.C-hq-board-emit shipped (PASS, 3 tasks). render_hq_board + plan_hq_board added to src/brain/emit.rs, completing Wave 2 alongside 4.B. Neither planner wired into emit_state yet (MV.4.E's job). Next: MV.4.E (spine terminus, wires MV.4.B + MV.4.C into emit_state)."
