...
3. Check for an active handoff: check if `planning/handoff.md` exists.
   - If the file exists, read it. Lead your summary with an **Active Handoff** section (see format below) before everything else. This is the most important thing a new session agent needs to see.
...
5. Delete `planning/handoff.md` once this session has consumed it.
6. Do not edit any other file. This command is read-only.
...
- `planning/context.md`
- `planning/status.md`
- `planning/handoff.md` (if present — check with check/view first)
